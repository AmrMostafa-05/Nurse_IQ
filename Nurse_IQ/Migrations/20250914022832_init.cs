    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "cfe618b9-3707-409b-b40a-510bbf681665", "Nursing Faculty", "admin@nurseiq.com", false, "System", "Admin", false, null, "ADMIN@NURSEIQ.COM", "ADMIN", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "e36925cc-d404-49c7-8b48-af55626544dc", false, "college", "admin", null, "male", "[\"Research\",\"Teaching\",\"Management\"]", "Doctor" },
                    { 2, 0, new DateTime(1985, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "2584c712-fdec-454a-9821-45e6e0a882e0", "جامعة القاهرة", "doctor1@nurseiq.com", false, "أحمد", "علي", false, null, "DOCTOR1@NURSEIQ.COM", "DOCTOR1", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "e2748472-a50e-47b0-a62b-53a908f1b3bf", false, "college", "doctor1", null, "male", "[\"Pharmacology\",\"ICU\",\"Pediatrics\"]", "Doctor" },
                    { 3, 0, new DateTime(1988, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "6f4dd5eb-8d08-4929-9d16-0b5dd1627549", "جامعة عين شمس", "doctor2@nurseiq.com", false, "فاطمة", "محمد", false, null, "DOCTOR2@NURSEIQ.COM", "DOCTOR2", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "927c1c99-2771-40db-9683-5e2339df223f", false, "college", "doctor2", null, "female", "[\"Surgery\",\"Emergency\",\"Cardiology\"]", "Doctor" },
                    { 4, 0, new DateTime(1982, 8, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "3b5541e0-1860-464f-8446-b144de9e54d0", "جامعة الإسكندرية", "doctor3@nurseiq.com", false, "محمد", "حسن", false, null, "DOCTOR3@NURSEIQ.COM", "DOCTOR3", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "66c6facb-a265-46bd-8bb6-163e5544787f", false, "college", "doctor3", null, "male", "[\"Neurology\",\"Psychiatry\",\"Research\"]", "Doctor" },
                    { 5, 0, new DateTime(2003, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "a306ce5f-080e-479a-8045-b501787051da", "معهد التمريض العالي", "student1@nurseiq.com", false, "سارة", "أحمد", false, null, "STUDENT1@NURSEIQ.COM", "STUDENT1", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "65124d4d-939a-41ac-8118-225d6d9203d4", false, "institute", "student1", "First_Year", "female", "[\"Pediatrics\",\"Emergency\",\"Community Health\"]", "Student" },
                    { 6, 0, new DateTime(2002, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "319485a5-510f-45ea-b198-3ca284849369", "كلية التمريض - جامعة القاهرة", "student2@nurseiq.com", false, "علي", "محمود", false, null, "STUDENT2@NURSEIQ.COM", "STUDENT2", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "96fda5fc-74ad-4260-a82e-11699af10c18", false, "college", "student2", "Sec_Year", "male", "[\"ICU\",\"Surgery\",\"Pharmacology\"]", "Student" },
                    { 7, 0, new DateTime(2001, 7, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "2dd5fa13-5120-4f73-a1d5-674f36b07206", "كلية التمريض - جامعة عين شمس", "student3@nurseiq.com", false, "مريم", "عبدالله", false, null, "STUDENT3@NURSEIQ.COM", "STUDENT3", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "84abd481-1e2e-426a-9d07-27c564e39500", false, "college", "student3", "Third_Year", "female", "[\"Mental Health\",\"Community Health\",\"Research\"]", "Student" },
                    { 8, 0, new DateTime(2000, 4, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "5e3e847e-028d-48f5-9ae6-9d1f0ae08fde", "كلية التمريض - جامعة الإسكندرية", "student4@nurseiq.com", false, "يوسف", "إبراهيم", false, null, "STUDENT4@NURSEIQ.COM", "STUDENT4", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "cfc1bc94-43b1-41fa-856b-9bc1e57c5e49", false, "college", "student4", "Fourth_Year", "male", "[\"Emergency\",\"Trauma\",\"Critical Care\"]", "Student" },
                    { 9, 0, new DateTime(1999, 9, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "27577338-f471-4670-81d1-20fe1a9223dd", "كلية التمريض - جامعة القاهرة", "excellence1@nurseiq.com", false, "نور", "السيد", false, null, "EXCELLENCE1@NURSEIQ.COM", "EXCELLENCE1", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "c7f40261-9d02-4fba-ad80-e0fe4f2aa147", false, "college", "excellence1", "Excellence_Year", "female", "[\"Research\",\"Leadership\",\"Advanced Practice\"]", "Excellence_student" },
                    { 10, 0, new DateTime(1998, 11, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "f0b69301-6493-406b-9c20-9448fb9281df", "كلية التمريض - جامعة عين شمس", "graduate1@nurseiq.com", false, "خالد", "محمد", false, null, "GRADUATE1@NURSEIQ.COM", "GRADUATE1", "AQAAAAEAACcQAAAAEHQ36c3VJt2fP+m3v/6rF3hHENu2eYi5...", null, false, "6401ad9b-5127-420e-b7c8-039e5361c822", false, "college", "graduate1", "Graduated", "male", "[\"Professional Development\",\"Specialization\",\"Teaching\"]", "graduate" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Offers",
                columns: new[] { "Id", "CreatedByAdminId", "Description", "OriginalPrice", "SubTitle", "Title", "category", "discountPercentage", "expiredAt", "features", "imageUrl" },
                values: new object[,]
                {
                    { 1, 1, "خصم خاص على دبلوم العناية المركزة مع تدريب عملي متقدم", 1000m, "وفر 20%", "عرض تدريب العناية المركزة", "Training", 20, new DateTime(2025, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062C\\u0644\\u0633\\u0627\\u062A \\u0639\\u0645\\u0644\\u064A\\u0629\",\"\\u0645\\u062F\\u0631\\u0628\\u0648\\u0646 \\u0645\\u0639\\u062A\\u0645\\u062F\\u0648\\u0646\",\"\\u0634\\u0647\\u0627\\u062F\\u0629 \\u0645\\u0639\\u062A\\u0645\\u062F\\u0629\"]", "img/offer1.png" },
                    { 2, 1, "خصم على دورة علم الأدوية مع مواد إضافية مجانية", 500m, "وفر 10%", "عرض دورة علم الأدوية", "Course", 10, new DateTime(2025, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u0645\\u0648\\u0627\\u062F \\u0645\\u062C\\u0627\\u0646\\u064A\\u0629\",\"\\u062A\\u0645\\u0627\\u0631\\u064A\\u0646 \\u0625\\u0636\\u0627\\u0641\\u064A\\u0629\",\"\\u062F\\u0639\\u0645 \\u0623\\u0643\\u0627\\u062F\\u064A\\u0645\\u064A\"]", "img/offer2.png" },
                    { 3, 2, "خصم كبير على برنامج تدريب الطوارئ الطبية", 800m, "وفر 25%", "عرض تدريب الطوارئ", "Training", 25, new DateTime(2025, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u0645\\u062D\\u0627\\u0643\\u0627\\u0629 \\u062D\\u0627\\u0644\\u0627\\u062A \\u0637\\u0648\\u0627\\u0631\\u0626\",\"\\u062A\\u062F\\u0631\\u064A\\u0628 \\u0639\\u0644\\u0649 \\u0627\\u0644\\u0645\\u0639\\u062F\\u0627\\u062A\",\"\\u0634\\u0647\\u0627\\u062F\\u0629 \\u062F\\u0648\\u0644\\u064A\\u0629\"]", "img/offer3.png" },
                    { 4, 1, "خصم خاص على جميع دورات التمريض المتقدم", 1200m, "وفر 30%", "عرض دورات التمريض المتقدم", "Course", 30, new DateTime(2025, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062F\\u0648\\u0631\\u0627\\u062A \\u0645\\u062A\\u062E\\u0635\\u0635\\u0629\",\"\\u0645\\u062A\\u0627\\u0628\\u0639\\u0629 \\u0634\\u062E\\u0635\\u064A\\u0629\",\"\\u0634\\u0647\\u0627\\u062F\\u0627\\u062A \\u0645\\u0639\\u062A\\u0645\\u062F\\u0629\"]", "img/offer4.png" },
                    { 5, 1, "ترحيب خاص بالطلاب الجدد - خصم كبير على أول دورة", 600m, "وفر 40%", "عرض الطلاب الجدد", "Course", 40, new DateTime(2025, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062E\\u0635\\u0645 \\u0625\\u0636\\u0627\\u0641\\u064A\",\"\\u0645\\u0648\\u0627\\u062F \\u0645\\u062C\\u0627\\u0646\\u064A\\u0629\",\"\\u062F\\u0639\\u0645 \\u0623\\u0643\\u0627\\u062F\\u064A\\u0645\\u064A\"]", "img/offer5.png" },
                    { 6, 2, "خصم خاص على جميع الدبلومات المهنية في التمريض", 2000m, "وفر 35%", "عرض الدبلومات المهنية", "Diploma", 35, new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062F\\u0628\\u0644\\u0648\\u0645\\u0627\\u062A \\u0645\\u0639\\u062A\\u0645\\u062F\\u0629\",\"\\u062A\\u062F\\u0631\\u064A\\u0628 \\u0639\\u0645\\u0644\\u064A\",\"\\u0641\\u0631\\u0635 \\u0639\\u0645\\u0644\"]", "img/offer6.png" },
                    { 7, 1, "عرض نهاية العام - خصم كبير على جميع الخدمات", 1500m, "وفر 50%", "عرض نهاية العام", "All", 50, new DateTime(2025, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062E\\u0635\\u0645 \\u0634\\u0627\\u0645\\u0644\",\"\\u062C\\u0645\\u064A\\u0639 \\u0627\\u0644\\u062E\\u062F\\u0645\\u0627\\u062A\",\"\\u0639\\u0631\\u0636 \\u0645\\u062D\\u062F\\u0648\\u062F\"]", "img/offer7.png" },
                    { 8, 1, "هذا العرض منتهي الصلاحية", 1000m, "انتهى العرض", "عرض منتهي الصلاحية", "Course", 50, new DateTime(2024, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u0639\\u0631\\u0636 \\u0645\\u0646\\u062A\\u0647\\u064A\"]", "img/offer8.png" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "img/admin.png", "نرحب بكم في منصة التمريض الرائدة في مصر. نقدم لكم أفضل المحتوى التعليمي والتدريبي في مجال التمريض", 1, new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "مرحباً بكم في منصة NursingIQ", "عام" },
                    { 2, "img/admin.png", "يسرنا أن نعلن عن إطلاق مجموعة جديدة من الدورات التدريبية المتخصصة في التمريض", 1, new DateTime(2025, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "إطلاق دورات جديدة في التمريض", "تحديث" },
                    { 3, "img/admin.png", "ورشة عمل مجانية حول أفضل الممارسات في التمريض في وحدات العناية المركزة - 25 يناير 2025", 1, new DateTime(2025, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "ورشة عمل حول التمريض في العناية المركزة", "فعاليات" },
                    { 4, "img/admin.png", "مسابقة شهرية لأفضل مقال في التمريض مع جوائز قيمة للفائزين", 1, new DateTime(2025, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "مسابقة أفضل مقال تمريضي", "مسابقات" },
                    { 5, "img/admin.png", "تم تحديث نظام الاختبارات ليشمل المزيد من الأسئلة التفاعلية والتقييم الذكي", 1, new DateTime(2025, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "تحديث نظام الاختبارات", "تحديث" },
                    { 6, "img/admin.png", "دورة تدريبية شاملة في الإسعافات الأولية مع شهادة معتمدة - التسجيل مفتوح الآن", 1, new DateTime(2025, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "دورة تدريبية في الإسعافات الأولية", "دورات" }
                });
            ...
            migrationBuilder.InsertData(
                table: "forumtopics",
                columns: new[] { "Id", "Description", "Title", "UserId", "category", "comments", "num_of_likes", "num_of_views" },
                values: new object[,]
                {
                    { 1, "شاركوا نصائحكم في دراسة التمريض وأفضل الطرق للاستذكار", "كيفية دراسة التمريض بفعالية؟", 5, "الدراسة", "[\"\\u0627\\u0633\\u062A\\u062E\\u062F\\u0645 \\u0627\\u0644\\u0628\\u0637\\u0627\\u0642\\u0627\\u062A \\u0627\\u0644\\u062A\\u0639\\u0644\\u064A\\u0645\\u064A\\u0629\",\"\\u0627\\u0644\\u062F\\u0631\\u0627\\u0633\\u0629 \\u0627\\u0644\\u062C\\u0645\\u0627\\u0639\\u064A\\u0629 \\u0645\\u0641\\u064A\\u062F\\u0629 \\u062C\\u062F\\u0627\\u064B\",\"\\u0631\\u0627\\u062C\\u0639 \\u0627\\u0644\\u0645\\u062D\\u0627\\u0636\\u0631\\u0627\\u062A \\u064A\\u0648\\u0645\\u064A\\u0627\\u064B\"]", 25, 450 },
                    { 2, "ناقش أفضل الكتب والملاحظات لدراسة علم الأدوية", "أفضل المصادر لدراسة علم الأدوية", 6, "علم الأدوية", "[\"\\u0643\\u062A\\u0627\\u0628 \\u0643\\u0627\\u062A\\u0632\\u0648\\u0646\\u062C \\u0641\\u064A \\u0639\\u0644\\u0645 \\u0627\\u0644\\u0623\\u062F\\u0648\\u064A\\u0629\",\"\\u0627\\u0644\\u0645\\u0644\\u0627\\u062D\\u0638\\u0627\\u062A \\u0627\\u0644\\u0645\\u062D\\u0644\\u064A\\u0629 \\u0645\\u0641\\u064A\\u062F\\u0629\",\"\\u0627\\u0633\\u062A\\u062E\\u062F\\u0645 \\u0627\\u0644\\u062A\\u0637\\u0628\\u064A\\u0642\\u0627\\u062A \\u0627\\u0644\\u062A\\u0639\\u0644\\u064A\\u0645\\u064A\\u0629\"]", 18, 320 },
                    { 3, "شاركوا تجاربكم في التدريب العملي في المستشفيات", "تجاربكم في التدريب العملي", 7, "التدريب العملي", "[\"\\u0627\\u0644\\u062A\\u062F\\u0631\\u064A\\u0628 \\u0641\\u064A \\u0627\\u0644\\u0639\\u0646\\u0627\\u064A\\u0629 \\u0627\\u0644\\u0645\\u0631\\u0643\\u0632\\u0629 \\u0643\\u0627\\u0646 \\u0635\\u0639\\u0628\\u0627\\u064B \\u0644\\u0643\\u0646 \\u0645\\u0641\\u064A\\u062F\\u0627\\u064B\",\"\\u062A\\u0639\\u0644\\u0645\\u062A \\u0627\\u0644\\u0643\\u062B\\u064A\\u0631 \\u0645\\u0646 \\u0627\\u0644\\u0645\\u0645\\u0631\\u0636\\u064A\\u0646 \\u0630\\u0648\\u064A \\u0627\\u0644\\u062E\\u0628\\u0631\\u0629\"]", 32, 580 },
                    { 4, "كيف تتعاملون مع المرضى الصعبيين أو العدوانيين؟", "نصائح للتعامل مع المرضى الصعبيين", 8, "الممارسة المهنية", "[\"\\u0627\\u0644\\u0635\\u0628\\u0631 \\u0648\\u0627\\u0644\\u062A\\u0641\\u0647\\u0645 \\u0645\\u0641\\u062A\\u0627\\u062D \\u0627\\u0644\\u0646\\u062C\\u0627\\u062D\",\"\\u0627\\u0633\\u062A\\u062E\\u062F\\u0645 \\u062A\\u0642\\u0646\\u064A\\u0627\\u062A \\u0627\\u0644\\u062A\\u0648\\u0627\\u0635\\u0644 \\u0627\\u0644\\u0641\\u0639\\u0627\\u0644\",\"\\u0627\\u0637\\u0644\\u0628 \\u0627\\u0644\\u0645\\u0633\\u0627\\u0639\\u062F\\u0629 \\u0645\\u0646 \\u0627\\u0644\\u0641\\u0631\\u064A\\u0642\"]", 28, 420 },
                    { 5, "ما هي أفضل التطبيقات التي تساعدكم في العمل؟", "أفضل التطبيقات للممرضين", 9, "التكنولوجيا", "[\"\\u062A\\u0637\\u0628\\u064A\\u0642 \\u062D\\u0633\\u0627\\u0628 \\u0627\\u0644\\u062C\\u0631\\u0639\\u0627\\u062A \\u0645\\u0641\\u064A\\u062F \\u062C\\u062F\\u0627\\u064B\",\"\\u062A\\u0637\\u0628\\u064A\\u0642 \\u0645\\u0631\\u0627\\u0642\\u0628\\u0629 \\u0627\\u0644\\u0639\\u0644\\u0627\\u0645\\u0627\\u062A \\u0627\\u0644\\u062D\\u064A\\u0648\\u064A\\u0629\",\"\\u062A\\u0637\\u0628\\u064A\\u0642 \\u0627\\u0644\\u0623\\u062F\\u0648\\u064A\\u0629 \\u0648\\u0627\\u0644\\u062A\\u0641\\u0627\\u0639\\u0644\\u0627\\u062A\"]", 15, 280 },
                    { 6, "نصائح لإدارة الوقت بكفاءة أثناء العمل في التمريض", "كيفية إدارة الوقت في التمريض", 10, "إدارة الوقت", "[\"\\u062E\\u0637\\u0637 \\u0645\\u0647\\u0627\\u0645\\u0643 \\u0645\\u0633\\u0628\\u0642\\u0627\\u064B\",\"\\u0627\\u0633\\u062A\\u062E\\u062F\\u0645 \\u0642\\u0648\\u0627\\u0626\\u0645 \\u0627\\u0644\\u0645\\u0647\\u0627\\u0645\",\"\\u062A\\u0639\\u0644\\u0645 \\u0623\\u0646 \\u062A\\u0642\\u0648\\u0644 \\u0644\\u0627 \\u0639\\u0646\\u062F \\u0627\\u0644\\u062D\\u0627\\u062C\\u0629\"]", 22, 350 }
                });

            migrationBuilder.InsertData(
                table: "medicalTerms",
                columns: new[] { "Id", "UserId", "arabicName", "category", "englishName", "example", "latinName", "synonyms" },
                values: new object[,]
                {
                    { 1, 2, "قلب", "التشريح", "Heart", "القلب يضخ الدم إلى جميع أنحاء الجسم", "Cor", "[\"\\u0642\\u0644\\u0628\\u064A\",\"\\u0642\\u0644\\u0628\\u064A \\u0648\\u0639\\u0627\\u0626\\u064A\"]" },
                    { 2, 2, "رئة", "التشريح", "Lung", "الرئة تساعد في التنفس وتبادل الغازات", "Pulmo", "[\"\\u0631\\u0626\\u0648\\u064A\",\"\\u062A\\u0646\\u0641\\u0633\\u064A\"]" },
                    { 3, 2, "كبد", "التشريح", "Liver", "الكبد يقوم بتصفية الدم وإنتاج الصفراء", "Hepar", "[\"\\u0643\\u0628\\u062F\\u064A\",\"\\u0647\\u064A\\u0628\\u0627\\u062A\\u064A\\u0643\"]" },
                    { 4, 3, "كلية", "التشريح", "Kidney", "الكلى تقوم بتصفية الدم وإنتاج البول", "Ren", "[\"\\u0643\\u0644\\u0648\\u064A\",\"\\u0631\\u064A\\u0646\\u0627\\u0644\"]" },
                    { 5, 2, "حمى", "الأعراض", "Fever", "الحمى هي ارتفاع في درجة حرارة الجسم", "Febris", "[\"\\u0627\\u0631\\u062A\\u0641\\u0627\\u0639 \\u0627\\u0644\\u062D\\u0631\\u0627\\u0631\\u0629\",\"\\u0633\\u062E\\u0648\\u0646\\u0629\"]" },
                    { 6, 3, "صداع", "الأعراض", "Headache", "الصداع هو ألم في الرأس أو الرقبة", "Cephalgia", "[\"\\u0623\\u0644\\u0645 \\u0627\\u0644\\u0631\\u0623\\u0633\",\"\\u0648\\u062C\\u0639 \\u0627\\u0644\\u0631\\u0623\\u0633\"]" },
                    { 7, 2, "غثيان", "الأعراض", "Nausea", "الغثيان هو الشعور بالرغبة في التقيؤ", "Nausea", "[\"\\u0631\\u063A\\u0628\\u0629 \\u0641\\u064A \\u0627\\u0644\\u062A\\u0642\\u064A\\u0624\",\"\\u062F\\u0648\\u062E\\u0629\"]" },
                    { 8, 3, "جراحة", "الإجراءات", "Surgery", "الجراحة هي إجراء طبي يتطلب قطع الأنسجة", "Chirurgia", "[\"\\u0639\\u0645\\u0644\\u064A\\u0629 \\u062C\\u0631\\u0627\\u062D\\u064A\\u0629\",\"\\u062A\\u062F\\u062E\\u0644 \\u062C\\u0631\\u0627\\u062D\\u064A\"]" },
                    { 9, 4, "تنفس صناعي", "الإجراءات", "Artificial Respiration", "التنفس الصناعي هو مساعدة المريض على التنفس", "Respiratio Artificialis", "[\"\\u062A\\u0647\\u0648\\u064A\\u0629 \\u0635\\u0646\\u0627\\u0639\\u064A\\u0629\",\"\\u062F\\u0639\\u0645 \\u062A\\u0646\\u0641\\u0633\\u064A\"]" },
                    { 10, 2, "مضاد حيوي", "الأدوية", "Antibiotic", "المضاد الحيوي يقتل البكتيريا أو يمنع نموها", "Antibioticum", "[\"\\u0645\\u0636\\u0627\\u062F \\u0628\\u0643\\u062A\\u064A\\u0631\\u064A\",\"\\u0645\\u0636\\u0627\\u062F \\u062C\\u0631\\u062B\\u0648\\u0645\\u064A\"]" },
                    { 11, 3, "مسكن ألم", "الأدوية", "Analgesic", "مسكن الألم يخفف من الشعور بالألم", "Analgeticum", "[\"\\u0645\\u062E\\u062F\\u0631\",\"\\u0645\\u0647\\u062F\\u0626\"]" }
                });

            migrationBuilder.InsertData(
                table: "medicines",
                columns: new[] { "Id", "UserId", "arabicName", "category", "description", "dosage", "englishName", "form", "indications", "latinName", "sideEffects" },
                values: new object[,]
                {
                    { 1, 2, "باراسيتامول", "مسكنات الألم", "مسكن للألم وخافض للحرارة", "500-1000 مجم كل 6-8 ساعات", "Paracetamol", "أقراص", "الحمى، الصداع، آلام الجسم", "Acetaminophen", "غثيان، طفح جلدي، تلف الكبد (بجرعات عالية)" },
                    { 2, 2, "إيبوبروفين", "مسكنات الألم", "مسكن للألم ومضاد للالتهاب", "200-400 مجم كل 6-8 ساعات", "Ibuprofen", "أقراص", "آلام المفاصل، الصداع، الحمى", "Ibuprofenum", "اضطراب المعدة، نزيف معوي، مشاكل في الكلى" },
                    { 3, 2, "أموكسيسيلين", "مضادات حيوية", "مضاد حيوي واسع الطيف", "250-500 مجم كل 8 ساعات", "Amoxicillin", "كبسولات", "التهابات الجهاز التنفسي، التهابات المسالك البولية", "Amoxicillinum", "إسهال، طفح جلدي، حساسية" },
                    { 4, 3, "أزيثروميسين", "مضادات حيوية", "مضاد حيوي من مجموعة الماكروليد", "500 مجم مرة واحدة يومياً لمدة 3 أيام", "Azithromycin", "أقراص", "التهابات الجهاز التنفسي، التهابات الجلد", "Azithromycinum", "غثيان، إسهال، اضطراب في المعدة" },
                    { 5, 3, "أتينولول", "أدوية القلب", "حاصرات بيتا لعلاج ارتفاع ضغط الدم", "25-100 مجم مرة واحدة يومياً", "Atenolol", "أقراص", "ارتفاع ضغط الدم، عدم انتظام ضربات القلب", "Atenololum", "بطء القلب، انخفاض ضغط الدم، تعب" },
                    { 6, 4, "أملوديبين", "أدوية القلب", "حاصرات قنوات الكالسيوم", "5-10 مجم مرة واحدة يومياً", "Amlodipine", "أقراص", "ارتفاع ضغط الدم، الذبحة الصدرية", "Amlodipinum", "تورم الكاحلين، صداع، دوخة" },
                    { 7, 2, "أوميبرازول", "أدوية الجهاز الهضمي", "مثبط مضخة البروتون", "20-40 مجم مرة واحدة يومياً", "Omeprazole", "كبسولات", "قرحة المعدة، ارتجاع المريء", "Omeprazolum", "صداع، غثيان، إسهال" },
                    { 8, 3, "دومبيريدون", "أدوية الجهاز الهضمي", "مضاد للغثيان والقيء", "10 مجم 3 مرات يومياً", "Domperidone", "أقراص", "الغثيان، القيء، عسر الهضم", "Domperidonum", "جفاف الفم، صداع، اضطراب في المعدة" },
                    { 9, 4, "سالبوتامول", "أدوية الجهاز التنفسي", "موسع للشعب الهوائية", "1-2 بخة حسب الحاجة", "Salbutamol", "بخاخ", "الربو، التهاب الشعب الهوائية", "Salbutamolum", "رعشة، تسارع ضربات القلب، صداع" },
                    { 10, 2, "بريدنيزولون", "أدوية الجهاز التنفسي", "كورتيكوستيرويد مضاد للالتهاب", "5-60 مجم يومياً حسب الحالة", "Prednisolone", "أقراص", "الربو الحاد، التهاب المفاصل", "Prednisolonum", "زيادة الوزن، ارتفاع ضغط الدم، هشاشة العظام" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "تعلم ممارسات الحقن الآمنة مع التركيز على السلامة والوقاية من العدوى", "تقنيات الحقن الآمنة", "مهارات عملية", "15 دقيقة", "img/doctor1.png", "د. أحمد محمد", "2025-09-13", "img/injection.png", "videos/injection.mp4" },
                    { 2, 2, "دليل خطوة بخطوة لتضميد الجروح مع التركيز على النظافة والسلامة", "تضميد الجروح", "مهارات عملية", "20 دقيقة", "img/doctor2.png", "د. فاطمة أحمد", "2025-06-23", "img/dressing.png", "videos/dressing.mp4" },
                    { 3, 1, "تعلم كيفية قياس النبض وضغط الدم ودرجة الحرارة بدقة", "قياس العلامات الحيوية", "مهارات عملية", "25 دقيقة", "img/doctor3.png", "د. محمد علي", "2025-08-15", "img/vitals.png", "videos/vitals.mp4" },
                    ...
                    { 5, 1, "مبادئ رعاية المرضى في العناية المركزة مع التركيز على المراقبة المستمرة", "رعاية مرضى العناية المركزة", "عناية مركزة", "35 دقيقة", "img/doctor5.png", "د. خالد حسن", "2025-05-20", "img/icu_care.png", "videos/icu_care.mp4" },
                    { 6, 2, "تعلم كيفية تشغيل ومراقبة أجهزة التنفس الصناعي", "استخدام أجهزة التنفس الصناعي", "عناية مركزة", "40 دقيقة", "img/doctor6.png", "د. مريم عبدالله", "2025-04-15", "img/ventilator.png", "videos/ventilator.mp4" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ICU", 1, "برنامج تدريبي متقدم في العناية المركزة مع تدريب عملي على أحدث المعدات", "سنتان", "مستشفى القاهرة الدولي", "القاهرة", "تدريب العناية المركزة", new DateTime(2025, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "img/training1.png", new DateTime(2025, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "[\"\\u062E\\u0628\\u0631\\u0629 \\u0641\\u064A \\u0627\\u0644\\u0639\\u0646\\u0627\\u064A\\u0629 \\u0627\\u0644\\u0645\\u0631\\u0643\\u0632\\u0629\",\"\\u0634\\u0647\\u0627\\u062F\\u0629 \\u062A\\u0645\\u0631\\u064A\\u0636\",\"\\u0634\\u0647\\u0627\\u062F\\u0629 BLS\"]", 5000m },
